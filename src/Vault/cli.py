...
# Command classes
from .commands import FieldCommand, UpdateCommand, CommitCommand, SummaryCommand, ShowCommand, HelpCommand, CommodityCommand, ExportCommand, ImportCommand, ExitCommand
...
class CLI:
    ...
    def __init__(self, logger, db=None, price_fetcher=None, test_mode=False):
        ...
        command_class_list = [ FieldCommand, UpdateCommand, CommitCommand, SummaryCommand, ShowCommand, HelpCommand, CommodityCommand, ExportCommand, ImportCommand, ExitCommand]
